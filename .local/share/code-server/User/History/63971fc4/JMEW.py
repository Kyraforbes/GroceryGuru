...
from .forms import UserInfoForm, HabitForm  # We'll add HabitForm
from .models import UserInfo, Habit, HabitLog  # We'll add Habit models
from rest_framework.decorators import api_view
from rest_framework.response import Response
from rest_framework.views import APIView
from rest_framework import status
from .serializers import UserInfoSerializer, HabitSerializer  # We'll create this
